...
const EXTENDED_TOOLBAR_WINDOW_WIDTH = EXTENDED_TOOLBAR_WINDOW_MARGIN + 44 + 10 // 44px toolbar width + close button offset
const EXTENDED_TOOLBAR_WINDOW_HEIGHT = EXTENDED_TOOLBAR_WINDOW_MARGIN + 90 + 10 // ~90px tall mode switcher
...
ipcMain.handle('set_auto_delete', (_event, value) => {
  rawLog('Setting auto delete:', value)

  store.set('auto_delete', value)
...
function toggleToolbar() {
  withThrottle(() => {
    ...
    // mainWindow.webContents.send('reset_screen'); // Joey added

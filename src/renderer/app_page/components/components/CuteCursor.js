...
import { colorList, interpolateWidthSettings } from "../constants.js"
...
const CuteCursor = ({
  ...
  const renderIconByToolName = (toolName) => {
    ...
    const widthInfo = interpolateWidthSettings(activeWidthIndex);
    const iconSize = widthInfo.icon_size;
    ...
    switch (toolName) {
      ...
      case "rectangle_filled":
        return <Icons.RectangleFilled {...iconProps} />;
      case "oval":
        return <Icons.Oval {...iconProps} />;
      case "oval_filled":
        return <Icons.OvalFilled {...iconProps} />;
      case "line":
